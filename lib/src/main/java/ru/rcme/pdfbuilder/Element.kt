...
abstract class Element(open val parent: Element?) {
    ...
    companion object {
        @JvmStatic
        private val FALLBACK_BACKGROUND_COLOR = AWTColor.WHITE

        @JvmStatic
        private val FALLBACK_FONT_COLOR = AWTColor.BLACK
    ...
    var backgroundColor: AWTColor? = null
    var fontColor: AWTColor? = null
